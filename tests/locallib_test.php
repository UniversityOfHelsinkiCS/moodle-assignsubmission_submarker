 ...
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class assignsubmission_submarker_locallib_testcase extends advanced_testcase {
    ...
    protected function setUp() {
        ...
        $params = [
            ...
            'assignsubmission_submarker_enabled' => 1,
        ];
     ...
     */
    public function test_submission_is_empty($submissionBoxes, $expected) {
        $this->resetAfterTest();

        $plugin = $this->assign->get_submission_plugin_by_type('submarker');

        $data = new stdClass();
        $data->exerchkbox1 = $submissionBoxes[0]
     ...
     * @param bool $expected The expected return value
     */
    public function test_new_submission_empty($submissionBoxes, $expected) {
        $this->resetAfterTest();
        $data = new stdClass();
        $data->exerchkbox1 = $submissionBoxes[0]
        $data->exerchkbox2 = $submissionBoxes[1]
        $data->exerchkbox3 = $submissionBoxes[2]
     ...
     * Never empty when plugin is used
