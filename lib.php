...
/**
 * This file contains the moodle hooks for the submarker plugin
 *
 ...
 */
function assignsubmission_submarker_pluginfile($course,
                                          $cm,
                                          context $context,
                                          $filearea,
                                          $args,
    ...
    $fullpath = "/{$context->id}/assignsubmission_submarker/$filearea/$itemid/$relativepath";
