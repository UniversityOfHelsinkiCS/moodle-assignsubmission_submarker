...
class assign_submission_submissionmarker extends assign_submission_plugin {
    ...
    public function save(stdClass $submission, stdClass $data) {
        ...
        unset($params['other']);        $this->debugObject($submission);
    ...
    public function view_summary(stdClass $submission, & $showviewlink) {
      ...
      $submissionmarkersubmission = $this->get_submissionmarker_submission($submission->id);
      $this->debugObject($submissionmarkersubmission);
    ...
    public function copy_submission(stdClass $sourcesubmission, stdClass $destsubmission) {
        ...
        // Copy the assignsubmission_submissionmarker record.
        if ($submissionmarkersubmission = $this->get_submissionmarker_submission($sourcesubmission->id)) {
            unset($submissionmarkersubmission->id);
            $submissionmarkersubmission->submission = $destsubmission->id;
            $DB->insert_record('assignsubmission_submarker', $submissionmarkersubmission);
        }
        return true;
    }
