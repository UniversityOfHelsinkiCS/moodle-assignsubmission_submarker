...
/**
 * The assignsubmission_submarker submission_updated event.
 *
...
/**
 * The assignsubmission_submarker submission_updated event class.
 *
 *
 * @package    assignsubmission_submarker
 * @copyright  2017 University of Helsinki
...
class submission_updated extends \mod_assign\event\submission_updated {
    ...
    public function get_description() {
        $descriptionstring = "The user with id '$this->userid' updated a submission marking in the assignment with course module id " .
